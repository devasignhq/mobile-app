...
This skill helps with common development tasks for the Devasign project, which is a monorepo containing a mobile app (Vite/React) and an API (Express).
...
- **packages/api**: The backend API built with Express.
