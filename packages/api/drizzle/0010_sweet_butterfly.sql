...
CREATE UNIQUE INDEX "ext_req_bounty_dev_pending_uniq_idx" ON "extension_requests" USING btree ("bounty_id","developer_id") WHERE "extension_requests"."status" = 'pending';--> statement-breakpoint
